...
-- 查看石家庄的房源
SELECT id, title, city, district, price, houseType, status 
FROM listings 
WHERE city = '石家庄' 
ORDER BY id DESC;
